...
Matrix & Matrix::SetOrtho( float w, float h, GLfloat zn, GLfloat zf )
{
	...
	m[ 2][ 0 ] = 0.0f,		m[ 2][ 1 ] = 0.0f,		m[ 2 ][ 2] = fRange,		m[ 2][3 ] = 0.0f;
	m[ 3][ 0 ] = 0.0f,		m[ 3][ 1 ] = 0.0f,		m[ 3 ][ 2] = fRange * zn,	m[ 3][3 ] = 1.0f;
	return *this;
